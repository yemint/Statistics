...
public class CrashHandlerUtil implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        CnSPUtils.put(mContext,AppConstants.SP_VALUE,true);
...
//                CnLogUtils.e("error : ", e.getMessage());
                e.printStackTrace();
            }
            //从操作系统中结束掉当前程序的进程
...
//                StringUtils.showMsgAsCenter(mContext,getCrashTip());
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            CnLogUtils.e("收集包信息时发生错误", e.getMessage());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                CnLogUtils.e("收集崩溃信息时发生错误", e.getMessage());
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        sb.append(result);
        CnLogUtils.e("result=============", sb.toString());
